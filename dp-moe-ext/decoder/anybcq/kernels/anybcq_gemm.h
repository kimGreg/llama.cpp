// DPMoE / decoder / anybcq — public GEMM interface (prefill).
//
...
// (dp_moe/encoders/impl/anybcq.py::reconstruct_weight).
//
...
// =====================================================================
// cuBLAS F16 GEMM wrapper. DPMoE's novelty is in the streaming +
