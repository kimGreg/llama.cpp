// DPMoE / decoder / anybcq / core — prefill / dense-fp16 GEMM path.
//
...
// =====================================================================
// dp_moe_ext launchers + helper kernels.
// =====================================================================
...
void launch_f32_to_f16(const void * src_f32, void * dst_f16,
    ...
    ::dp_moe_ext::launch_diag::note_launch(
        ::dp_moe_ext::launch_diag::Kind::F32ToF16);
