// DPMoE / qwen3 — fused MoE LUT-GEMV (Qwen3-MoE architecture).
//
...
// ``dp_moe_ext::`` namespace level — both core/scheduler.h's
...
//                                                    — Gemma 4 MoE
//
// Same formula as ggml_cuda_op_{silu,gelu}_single so the dp_moe
