// streamllm-ext / decoder / anybcq — MoE chunked-matmul dispatch.
//
// ────────────────────────────────────────────────────────────────────
...
// the M1 ``clear()`` path alongside the other streamllm-ext counters.
// =====================================================================
...
// Resets all three to zero.  Called from the streamllm-ext clear path.
void reset_counters();
