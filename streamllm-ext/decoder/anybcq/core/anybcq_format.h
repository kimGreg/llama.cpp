// streamllm-ext / decoder / anybcq — single source of truth for the
// AnyBCQ byte stream layout.
//
// **MIRROR THIS FILE IN PYTHON**:
//   src/streamllm/encoders/format/anybcq_format.py
//
// Every constant / struct here has an identical counterpart in the
// Python file. The cross-language test
//   src/streamllm/encoders/tests/test_anybcq_format_parity.py
...
// is the GGUF tensor `streamllm.bytes.<canonical>` blob.
