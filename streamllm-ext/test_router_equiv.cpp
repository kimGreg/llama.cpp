// streamllm-ext — M1 cutover S3: router/topk equivalence test.
//
...
//
// Build target: streamllm-router-equiv-test
//
// Run: CUDA_VISIBLE_DEVICES=7 streamllm-router-equiv-test
//
