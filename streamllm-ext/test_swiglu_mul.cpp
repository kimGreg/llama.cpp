// streamllm-ext — M1 cutover S6: correctness test for
// streamllm_ext::qwen3::launch_swiglu_mul.
//
...
//
// Build target: streamllm-swiglu-mul-test
//
// Run: CUDA_VISIBLE_DEVICES=7 streamllm-swiglu-mul-test
//
...
using streamllm_ext::qwen3::launch_swiglu_mul;
...
bool run_known_answer() {
    ...
    launch_swiglu_mul(gate_d, up_d, out_d, N,
                      (streamllm_ext::StreamHandle) (cudaStream_t) 0);
