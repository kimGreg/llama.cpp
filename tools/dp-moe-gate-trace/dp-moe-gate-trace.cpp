...
// trace file consumed by experiments/dp_moe_pareto.
//
...
//
// CLI:
//   dp-moe-gate-trace -m model.gguf -f corpus.txt -o trace.bin
...
static void print_usage(int, char ** argv) {
    LOG("\ndp-moe-gate-trace — capture per-(layer, token) MoE gate-score "
