...
struct server_routes {
    ...
    server_http_context::handler_t post_streamllm_kbar;
    server_http_context::handler_t get_streamllm_kbar;
    server_http_context::handler_t post_streamllm_kbar_schedule;
